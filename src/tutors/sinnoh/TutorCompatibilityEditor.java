...
//        editor.csvToCompatibility("tutorCompatibilityData.csv","overlay9_5_C.bin");
    ...
    private static final int S_TUTORS_PT_F= 0x30127;
    private static final int S_TUTORS_PT_G= 0x30127;
    private static final int S_TUTORS_PT_I= 0x30127;
    private static final int S_TUTORS_PT_S= 0x30127;
    private static final int S_TUTORS_PT_K= 0x30127;
    ...
    public void compatibilityToCsv(Buffer buffer) throws IOException
    {
        ...
        for(int i= 0; i < 38; i++)
        {
            csvWriter.write("='Tutor Move List'!B" + (i+2) + ",");
        }
        csvWriter.write("\n");

        String line;
        for(int row= 0; row < compatibilityTable.length; row++)
        {
