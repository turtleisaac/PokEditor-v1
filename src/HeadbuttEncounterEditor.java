...
public class HeadbuttEncounterEditor
{
    ...
    public void headbuttToCsv(String headbuttDir) throws IOException
    {
        ...
        if(!new File(path + "Headbutt Temp Data").mkdir() && !new File(path + "Headbutt Temp Data").exists())
        {
        ...
        for(int i= 0; i < files.length; i++)
        {
            ...
            BinaryWriter binaryWriter= new BinaryWriter(new File(path + "Headbutt Temp Data" + separator + i + ".bin"));
