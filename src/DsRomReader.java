        ...
        if(args[0].equalsIgnoreCase("help"))
        {
            ...
            switch (args[1].toLowerCase())
            {
                ...
                case "growth" :
                    ...
                    System.out.println("The Growth table narc is used to store the amount of exp required for each level for each species of Pokémon");
                    ...
                    System.out.println("The spreadsheet that is generated by running this command (and therefore needs to be exported from the templates when you are done editing) is \"growth.csv\"");
                    System.out.println("Make sure to append the file names with \"Recompile\" prior to the file extension (don't add any spaces)");
                    System.out.println("This editor currently works for all Gen 4 games");
                    break;
