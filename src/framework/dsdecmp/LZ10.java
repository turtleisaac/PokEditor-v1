...
//    {
//        return "Common LZ-type compression used in many post-GBC Nintendo games.";
//    }
//
//
...
//    }
//
//    private static boolean lookAhead = false;
//
...
//    // implementation.
//    public static boolean LookAhead(boolean value)
//    {
...
//    public int ParseCompressionOptions(String[] args)
//    {
//        if (args.length > 0)
//            if (args[0] == "-opt")
//            {
...
//    public  long Decompress(Buffer instream, long inLength,
//                            Buffer outstream)
//    {
//            /*  Data header (32bit)
//                  Bit 0-3   Reserved
...
//
//    public int Compress(Stream instream, long inLength, Stream outstream)
//    {
...
//    private void GetOptimalCompressionLengths(byte* indata, int inLength, out int[] lengths, out int[] disps)
//    {
