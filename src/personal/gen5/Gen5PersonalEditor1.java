...
public class Gen5PersonalEditor1
{
    ...
    public Gen5PersonalEditor1() throws IOException
    {
    ...
    public void personalToCSV(String personalDir) throws IOException
    {
        ...
        String[][] pokeTable= new String[dataList.size()+1][38];
...
//                pokeTable[row][idx++]= nameData[dataList.get(row).getForm()];
        ...
        String line;
        writer.write("ID Number,Name,HP,Attack,Defense,Speed,Sp. Atk,Sp. Def,Type 1,Type 2,Catch Rate,Stage (1 or 2 for Eviolite),HP EV Yield,Spe EV Yield,Attack EV Yield,Defense EV Yield,Sp. Atk EV Yield,Sp. Def EV Yield,Held Item 1,Held Item 2,Held Item 3,Gender Ratio,Hatch Multiplier,Base Happiness,Growth Rate,Egg Group 1,Egg Group 2,Ability 1,Ability 2,Hidden Ability,Run Chance (Safari Zone only),Alt Form 1,Form Change ID,# of Forms,DO NOT TOUCH,Exp Drop,Height,Weight\n");
        for(int row= 0; row < dataList.size(); row++)
        {
            line= "";
    ...
    public void csvToPersonal(String personalCsv, String tmLearnsetCsv, String outputDir) throws IOException
    {
        ...
        for(int row= 0; row < yValue; row++)
        {
            ...
            personalData.add(new Gen5PersonalData() {
                ...
                @Override
                public int getWeight() {
                    return Integer.parseInt(finalCsvRow[35]);
                }
    ...
    {
        Arrays.sort(arr, Comparator.comparingInt(Gen5PersonalEditor1::fileToInt));
    }
