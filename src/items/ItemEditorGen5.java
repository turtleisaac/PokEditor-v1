...
public class ItemEditorGen5
{
    public static void main(String[] args) throws IOException
    {
        ItemEditorGen5 editorGen4= new ItemEditorGen5();
    ...
    public ItemEditorGen5() throws IOException
    {

        BufferedReader reader= new BufferedReader(new FileReader(resourcePath + "EntryDataGen5-1.txt"));
    ...
    public void itemsToCsv(String itemDir) throws IOException
    {
    ...
    public void csvToItems(String itemCsv, String outputDir) throws IOException
    {
        String itemPath= path + itemCsv;
        String outputPath;
        ...
        CsvReader csvReader= new CsvReader(itemPath);
        BinaryWriter writer;
    ...
    {
        Arrays.sort(arr, Comparator.comparingInt(ItemEditorGen5::fileToInt));
    }
    ...
    private static int getFieldFunction(String function)
    {
        ...
        {
            if(function.equals(fieldFunctions[i]))
            {
                return i;
            }
        }
